...
def findmean(x):
    ...
    """
#    mean_t = np.mean(signal2array)
#    mean_f = np.asarray(mean_t)
...
#    LPC_all = []
    wavs = []
    feature = []
    src_dir = "C:\\Users\\IBM_ADMIN\\Documents\\Python Scripts\\SingleFileTesting"
...
#%% Reading from Json Male    
import json
import numpy as np

with open('C:\Users\IBM_ADMIN\Documents\Python Scripts\TestedFeature\parameters.json', 'r') as fp:
    data = json.load(fp)
    
normalized_mean = np.asarray(data['mean'])
normalized_scale = np.asarray(data['scale'])

normalized_testing_data = (Z-normalized_mean)/normalized_scale    

np.save('C:\Users\IBM_ADMIN\Documents\Python Scripts\SingleFileTesting\Testing_Norm_Data_Female2.npy',normalized_testing_data)
#%% Reading from Json Female    
import json
import numpy as np

with open('C:\Users\IBM_ADMIN\Documents\Python Scripts\TestedFeature\parametersFemale.json', 'r') as fp:
    data = json.load(fp)
...
np.save('C:\Users\IBM_ADMIN\Documents\Python Scripts\SingleFileTesting\Testing_Norm_Data_Female_Complete.npy',normalized_testing_data)

#%% Reading from Json Mixed training Female Testing
import json
import numpy as np

with open('C:\Users\IBM_ADMIN\Documents\Python Scripts\TestedFeature\parametersMixed.json', 'r') as fp:
    data = json.load(fp)
...
np.save('C:\Users\IBM_ADMIN\Documents\Python Scripts\SingleFileTesting\Testing_Norm_Data_Mixed.npy',normalized_testing_data)

#%% Reading from Json Mixed training Male Testing
import json
import numpy as np

with open('C:\Users\IBM_ADMIN\Documents\Python Scripts\TestedFeature\parametersComplete.json', 'r') as fp:
    data = json.load(fp)
...
np.save('C:\Users\IBM_ADMIN\Documents\Python Scripts\SingleFileTesting\Testing_Norm_Data_Complete2.npy',normalized_testing_data)
